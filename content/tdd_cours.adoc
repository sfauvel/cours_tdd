...
// - *_link:https://codemanship.wordpress.com/category/tdd/[TDD]_* +
...
- link:https://www.youtube.com/watch?v=EW98_rwUQec[TDD : pour que votre code soit testable et testé!] +
[.small]#Xavier Nopre, 2019#

- link:https://www.youtube.com/watch?v=mYGS1hhEHZc[Xavier Screen Cast 3, Premier test unitaire et intro TDD] +
[.small]#présentation du TDD à partir de 6mn#

- link:https://www.youtube.com/watch?v=vBJM5pzBfhY[Test-Driven Development (TDD) in Python 1 - The 3 Steps of TDD] +
[.small]#Jason Gorman#

- link:https://www.youtube.com/watch?v=h-4i5N89TUI[Unit Testing Is The BARE MINIMUM] +
[.small]#Dave Farley#
...
// * link:https://www.youtube.com/@EmilyBache-tech-coach/search?query=TDD[] (TDD) - Emily Bache
// * link:https://www.youtube.com/@Codemanship/search?query=Test-Driven%20Development[Test-Driven Development] - Jason Gorman

// * link:https://www.youtube.com/watch?v=qu9p6yEURYI[C'est quoi le TDD ? (TEST DRIVEN DEVELOPMENT)]
// * link:https://www.youtube.com/watch?v=wMY5FE59rkI[Qu'est ce que le TDD ?] - Artisan Développeur
// * link:https://www.youtube.com/watch?v=wbZ6jWmRY14[Comment faire du TDD ?] - Artisan Développeur

// * link:https://www.youtube.com/watch?v=k7_WBqd6C0Y[TDD - test driven development - La Minute Agile Scrum #91] - La Minute Agile - Agile, Scrum, AI
...
* CodingDojo: http://codingdojo.org/kata/
// Enoncés
// * Yosethegame: https://github.com/yosethegame/yosethegame
// Apprendre le TDD en faisant passer les tests petit à petit
// * Coding Game: https://www.codingame.com/start
// Développer avec des tests à faire passer. Nombreux langages. Pas vraiment TDD

// https://github.com/luontola/tdd-tetris-tutorial
// https://www.youtube.com/watch?v=fmddhJQIIcc&list=PLSADDT9dzgRCjVvS13ekPr1KwX_JkDQJM&index=1
